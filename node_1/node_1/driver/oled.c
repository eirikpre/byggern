...
void write_c(unsigned char out_data);	// Write Command
void write_d(unsigned char out_data);	// Write Data
void oled_print_char(char* input);		// Print a single character
